// codeunit 50902 "Send Change Payment Request"
// {

//     procedure SendEmail(Rec: Record "ManualApprovalPaymentRequest"): Text;
//     var
...
//     begin
//         if Rec."Approval Status" = 'Approve' then begin
//             // Ensure that the correct record is passed and exists
//             if CompanyInfo.Get() then begin
//                 // Create the email message
//                 EmailMessage.Create(
//                     PaymentMode."Tenant Email", // The recipient's email address
//                     'Payment Mode Details - ' + Format(Rec."Contract ID"),
//                     '<html><body>' +
//                     '<p>Dear ' + PaymentMode."Tenant Name" + ',</p>' +
...
//                     '<b>Amount Including VAT:</b> ' + Format(Rec."Change Amount Including VAT") + '<br/>' +
...
//                     Message('Email sent successfully for Payment Mode: %1', PaymentMode."Tenant Email")
//                 else
