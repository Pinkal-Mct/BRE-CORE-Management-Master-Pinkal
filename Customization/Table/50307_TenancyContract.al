table 50307 "Tenancy Contract"
{
    ...
    begin
        ...
        if not contractLine.FindFirst() then begin
            // Message('No contract found for Proposal ID: %1', Rec."Proposal ID");
            exit;
        end;

        if contractLine."Vendor ID" = '' then begin
            //  Message('Vendor ID is blank');
            exit;
        end;
